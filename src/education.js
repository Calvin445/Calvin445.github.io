const edu = new Vue({
    ...
    template: `    
        ...
        <div class="table">
            <p class="rB tableHead">GPA:</p>
            <p class="rB tableContents">3.95 / 4.00</p>
        </div>
        <div class="table">
            <p class="rB tableHead">Honors:</p>
            <p class="rB tableContents">Dean's List, Honors Program, Khoury College Fellow</p>
        </div>    
    </div>`
})